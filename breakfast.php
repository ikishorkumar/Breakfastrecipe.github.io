			...
			<div class="navbar-header">	
				...
				<div class="collapse navbar-collapse" id="myNavbar">
					...
					<li>
						...
						<button class="btn btn-default bt" type="button" >Search</button>
					</li>
...
<div class="container cnt" >
	<h1 class="fnt">Recipe</h1>
			<div class="row">	  
				<div class="col-md-6">
					<a href="#"><img class="img-responsive img-rounded" src="imgg/pic6.jpg" style="height: 420px;"></a>		
				</div>
				<div class="col-md-6">
					<p class="text-justify" style="overflow-y: scroll; height: 420px; font-size: 15px;">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
	...
	<h1 class="fnt">Recipe</h1>
			<div class="row">	  
				...
				<div class="col-md-6">
					<a href="#"><img class="img-responsive img-rounded" src="imgg/pic8.jpg" style="height: 420px;"></a>		
				</div>
			</div>
	<h1 class="fnt">Recipe</h1>
			<div class="row">	  
				<div class="col-md-6">
					<a href="#"><img class="img-responsive img-rounded" src="imgg/pic7.jpg" style="height: 420px;"></a>		
				</div>
				<div class="col-md-6">
					<p class="text-justify" style="overflow-y: scroll; height: 420px; font-size: 15px;">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
						Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
